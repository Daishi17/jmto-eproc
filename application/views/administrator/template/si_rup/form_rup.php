                                ...
                                <td>
                                    <small>
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" class="form-control" placeholder="Kode RUP <Auto Number>" disabled>
                                        </div>
                                    </small>
                                </td>
                                <td>
                                                    ...
                                                    <small>
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <select class="form-select" aria-label="Default select example">
                                                                ...
                                                                <option value="4">Jasa Pengadaan Barang</option>
                                                            </select>
                                                        </div>
                                                        <small>
                                                </td>
                                                    ...
                                                    <small>
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <select class="form-select" aria-label="Default select example">
                                                                ...
                                                                <option value="3">Cpaex - Opex</option>
                                                            </select>
                                                        </div>
                                                        <small>
                                                </td>
                                                ...
                                                <td>
                                                    <small>
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="number" class="form-control" placeholder="360">
