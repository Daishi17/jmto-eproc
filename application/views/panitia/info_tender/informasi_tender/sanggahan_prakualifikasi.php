...
<input type="hidden" name="url_open_sanggahan_pra" value="<?= base_url('file_paket/' . $row_rup['nama_rup'] . '/' . $this->session->userdata('nama_usaha') . '/SANGGAHAN_PRAKUALIFIKASI' . '/') ?>">
            ...
            <form action="javascript:;" id="form_sanggahan_prakualifikasi">
                <div class="modal-body">
                    <div class="alert alert-primary d-flex align-items-center" role="alert">
                        <div>
                            <i class="fa fa-info-circle" aria-hidden="true"> </i> Balas Sanggahn Prakulifikasi !!! <br>
                        </div>
                    </div>
