...
class M_rup extends CI_Model
{
    ...
    // get nib
    private function _get_data_query_rup_panitia()
    {
        $this->db->select('*');
    ...
    public function gettable_rup_panitia() //nam[ilin data pake ini
    {
        $this->_get_data_query_rup_panitia(); //ambil data dari get yg di atas
        if ($_POST['length'] != -1) {
            $this->db->limit($_POST['length'], $_POST['start']);
        }
        $query = $this->db->get();
    ...
    public function count_filtered_rup_panitia()
    {
        $this->_get_data_query_rup_panitia(); //ambil data dari get yg di atas
        $query = $this->db->get();
        return $query->num_rows();
    ...
    public function count_all_rup_panitia()
    {
        $this->db->from('tbl_panitia');
        $this->db->join('tbl_manajemen_user', 'tbl_manajemen_user.id_manajemen_user = tbl_panitia.id_manajemen_user', 'left');
        $this->db->join('tbl_pegawai', 'tbl_pegawai.id_pegawai = tbl_manajemen_user.id_pegawai', 'left');
