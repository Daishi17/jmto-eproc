                    ...
                    <table id="example1" class="table table-bordered table-sm table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><small><span class="badge bg-warning text-dark">Draft RUP</span></small></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><small>Human Capital & General Affair</small></td>
                                <td><small>1.500.000.000</small></td>
                                <td><small><span class="badge bg-success text-white">Finalisasi RUP</span></small></td>
                                <td>
                                    <div class="text-center">
                        ...
                        <div class="col">
                            <div class="card border-dark shadow-lg">
                                <div class="card-header border-dark bd-blue-700 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="bd-highlight">
                                        <a href="http://localhost/etender-jmto/administrator/Sirup_form_rup">
                                                            ...
                                                            <table id="example2" class="table table-bordered table-sm table-striped">
                                                                <thead class="bg-secondary">
                                                                    <tr>
                                                                        ...
                                                                        <th style="width:10%;"><small class="text-white">Status</small></th>
                                                                        <th style="width:10%;"><small class="text-white"><div class="text-center">Options</div></small></th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="text-center">
                                                                                <a type="button" class="btn btn-info btn-sm shadow-lg" href="http://localhost/etender-jmto/administrator/Sirup_form_rup">
                                    ...
                                    <table class="table table-bordered table-sm">
                                        ...
                                        <tr>
                                            <th class="bg-light" colspan="2">
                                                ...
                                                <a href="http://localhost/etender-jmto/administrator/Sirup_form_rup" class="btn btn-sm btn-warning">
